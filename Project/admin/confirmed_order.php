                      ...
                      <thead class="thead-light">
                       ...
                       <tbody class="text-center">
                          <?php
                                    ...
                                    $order_query = "SELECT * FROM checkout WHERE status='confirmed'";
                            ...
                            ?> 
                             <tr>
                               ...
                               if($order_status == 'confirmed'){
                                     ...
                                     <input type='submit' class='btn btn-primary' name='confirm' value='Order delivered'>
                                  ...
                                  {
                                     $oid=$_POST['oid'];
                                     mysqli_query($con,"update checkout set status='delivered' where oid='$oid'");
                                        echo "<script>alert('Successfully Delevered !!!!!');</script>";
                                        echo "<script>window.location.assign('delivered_pro.php');</script>";
                                        }?></td>
                             </tr>   
                           <?php 
                                  }
